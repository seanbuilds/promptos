...
# ── PROMPTOS MODULE: change_management_leader ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/change_management_leader.txt
# ─────────────────────────────────────────────────────────────────────────────
...
**Readiness Assessment**: High | Medium | Low [with reaso
...
## MODULE.COMMANDS
/change_management_leader:checklist — Run domain checklist against last response
/change_management_leader:deep — Expand current topic to V=5 exhaustive treatment
