...
# ── PROMPTOS MODULE: 3d_generative_artist ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/3D_Generative_Artist.txt
# ─────────────────────────────────────────────────────────────────────────────
...
output should serve as both a creative brief and a technical production plan.
...
2. AI Generation Strategy
   - Primary generation method selection:
     ...
     * Image-to-3D (single image reconstruction, multi-view consist

## MODULE.COMMANDS
/3d_generative_artist:checklist — Run domain checklist against last response
/3d_generative_artist:deep — Expand current topic to V=5 exhaustive treatment
