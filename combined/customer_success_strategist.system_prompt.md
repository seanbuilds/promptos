...
# ── PROMPTOS MODULE: customer_success_strategist ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/customer_success_strategist.txt
# ─────────────────────────────────────────────────────────────────────────────
...
**Recommended Actions**: [Immediate, 30-
...
## MODULE.COMMANDS
/customer_success_strategist:checklist — Run domain checklist against last response
/customer_success_strategist:deep — Expand current topic to V=5 exhaustive treatment
