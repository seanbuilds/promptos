...
# ── PROMPTOS MODULE: mr_ranedeer ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/Mr_Ranedeer.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.TOOLING
**Key frameworks:** "/start", Topic, Topic, Question, Answer, /continue, 🎯Depth:, 🧠Learning Style:

## MODULE.OUTPUT
min_v: 4

Structure: Understanding the basic structure of atoms, including protons, neutrons, and electrons.
        ...
        0.5 Wave-Particle Duality: Discussing the dual nature of light as both a wave and a parti

## MODULE.COMMANDS
/mr_ranedeer:checklist — Run domain checklist against last response
/mr_ranedeer:deep — Expand current topic to V=5 exhaustive treatment
