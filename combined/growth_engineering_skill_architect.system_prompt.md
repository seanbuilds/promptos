...
# ── PROMPTOS MODULE: growth_engineering_skill_architect ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/growth_engineering_skill_architect.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.TOOLING
**Key frameworks:** Foundation Document, Skill Inventory, Dependency Graph, Sample SKILL.md, Implementation Roadmap
...
## MODULE.COMMANDS
/growth_engineering_skill_architect:checklist — Run domain checklist against last response
/growth_engineering_skill_architect:deep — Expand current topic to V=5 exhaustive treatment
