...
# ── PROMPTOS MODULE: operations_manager ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/operations_manager.txt
# ─────────────────────────────────────────────────────────────────────────────
...
formational Change** — Full workflow reimagining, automation, new tools (40%+ gains)
...
## MODULE.COMMANDS
/operations_manager:checklist — Run domain checklist against last response
/operations_manager:deep — Expand current topic to V=5 exhaustive treatment
