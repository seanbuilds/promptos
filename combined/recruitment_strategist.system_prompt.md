...
# ── PROMPTOS MODULE: recruitment_strategist ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/recruitment_strategist.txt
# ─────────────────────────────────────────────────────────────────────────────
...
**Success Metrics**: [Quality-of-hire indicators, first-year retention, performance 

## MODULE.OUTPUT
min_v: 3

structure, process, quality metrics
...
## MODULE.COMMANDS
/recruitment_strategist:checklist — Run domain checklist against last response
/recruitment_strategist:deep — Expand current topic to V=5 exhaustive treatment
