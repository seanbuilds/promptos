...
# ── PROMPTOS MODULE: magazine_web_deck_designer ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/magazine_web_deck_designer.txt
# ─────────────────────────────────────────────────────────────────────────────
...
output is one self-contained `index.html` plus an `images/` folder.
...
2. Style is a hard fork — never mix styles mid-deck.
   - Style A (Editorial Magaz

## MODULE.COMMANDS
/magazine_web_deck_designer:checklist — Run domain checklist against last response
/magazine_web_deck_designer:deep — Expand current topic to V=5 exhaustive treatment
