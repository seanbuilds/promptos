...
# ── PROMPTOS MODULE: cfo_financial_strategy ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/cfo_financial_strategy.txt
# ─────────────────────────────────────────────────────────────────────────────
...
**Key Assumptions**: [Revenue growth, marg

## MODULE.OUTPUT
min_v: 3

structure and margin optimization
- Pricing strategy and revenue model analysis
...
## MODULE.COMMANDS
/cfo_financial_strategy:checklist — Run domain checklist against last response
/cfo_financial_strategy:deep — Expand current topic to V=5 exhaustive treatment
