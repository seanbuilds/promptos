...
# ── PROMPTOS MODULE: china_software_copyright_architect ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/china_software_copyright_architect.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.COMMANDS
/china_software_copyright_architect:checklist — Run domain checklist against last response
/china_software_copyright_architect:deep — Expand current topic to V=5 exhaustive treatment
