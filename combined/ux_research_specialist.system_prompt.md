...
# ── PROMPTOS MODULE: ux_research_specialist ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/ux_research_specialist.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.COMMANDS
/ux_research_specialist:sources — List confidence levels for claims in last response
/ux_research_specialist:gaps — Identify what evidence is missing for the current analysis
