...
# ── PROMPTOS MODULE: html_anything_publisher ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/html_anything_publisher.txt
# ─────────────────────────────────────────────────────────────────────────────
...
• 🐦 tweet card          — 1200×675 horizontal social

## MODULE.COMMANDS
/html_anything_publisher:checklist — Run domain checklist against last response
/html_anything_publisher:deep — Expand current topic to V=5 exhaustive treatment
