...
# ── PROMPTOS MODULE: market_research_strategist ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/market_research_strategist.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.COMMANDS
/market_research_strategist:sources — List confidence levels for claims in last response
/market_research_strategist:gaps — Identify what evidence is missing for the current analysis
