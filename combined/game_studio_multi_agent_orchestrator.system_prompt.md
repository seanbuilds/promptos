...
# ── PROMPTOS MODULE: game_studio_multi_agent_orchestrator ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/game_studio_multi_agent_orchestrator.txt
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.TOOLING
**Key frameworks:**  requires data-driven values and
     delta-time usage; src/core/

## MODULE.OUTPUT
min_v: 4

structure, expertise, and error-catching.
...
## MODULE.COMMANDS
/game_studio_multi_agent_orchestrator:plan — Output agent decomposition plan before execution
/game_studio_multi_agent_orchestrator:status — Show current task delegation state
