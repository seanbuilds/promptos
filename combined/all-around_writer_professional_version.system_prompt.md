...
# ── PROMPTOS MODULE: all-around_writer_professional_version ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/✏️All-around Writer (Professional Version).md
# ─────────────────────────────────────────────────────────────────────────────
...
## MODULE.COMMANDS
/all-around_writer_professional_version:checklist — Run domain checklist against last response
/all-around_writer_professional_version:deep — Expand current topic to V=5 exhaustive treatment
