# ── PROMPTOS MODULE: talk_normal_enabler ─────────────────────────────────────────────
# Version: 1.0
# Kernel compatibility: PromptOS v2.0+
# Source: awesome-prompts/talk_normal_enabler.txt
# ─────────────────────────────────────────────────────────────────────────────
...
formative. No filler, no fluff, but give enough to be useful.
...
## MODULE.COMMANDS
/talk_normal_enabler:checklist — Run domain checklist against last response
/talk_normal_enabler:deep — Expand current topic to V=5 exhaustive treatment
